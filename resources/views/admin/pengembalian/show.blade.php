...
<div class="p-4 md:p-6 max-w-3xl mx-auto">
    ...
    <a href="{{ route('admin.pengembalian.index') }}" class="mb-4 inline-block text-sm text-gray-500 hover:text-gray-700 dark:text-gray-400">
    ...
    <div class="mb-6 rounded-lg bg-blue-50 p-3 text-xs text-blue-600 dark:bg-blue-500/10 dark:text-blue-400">
        Setelah kamu verifikasi, pengembalian ini akan diteruskan ke supervisor untuk verifikasi final. Stok barang belum berubah di tahap ini.
    </div>

    <div class="flex gap-2">
        <form action="{{ route('admin.pengembalian.verify', $pengembalian->id) }}" method="POST"
              onsubmit="return confirm('Teruskan pengembalian ini ke supervisor?')">
            @csrf
            <x-ui.button size="md" variant="primary" type="submit">Teruskan ke Supervisor</x-ui.button>
        </form>
