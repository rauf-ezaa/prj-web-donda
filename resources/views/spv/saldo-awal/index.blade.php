...
<div class="p-4 md:p-6">
    <div class="mb-6">
        <h1 class="text-title-sm font-semibold text-gray-800 dark:text-white/90">Verifikasi Saldo Awal</h1>
        <p class="text-sm text-gray-500 dark:text-gray-400">Daftar pencatatan saldo awal yang menunggu verifikasi.</p>
    </div>
                ...
                @forelse($saldoAwals as $index => $s)
                    <tr class="text-gray-700 dark:text-gray-300">
                        ...
                        <td class="px-4 py-3 text-right">
                            <a href="{{ route('spv.saldo-awal.show', $s->id) }}">
                                <x-ui.button size="sm" variant="primary">Verifikasi</x-ui.button>
                            </a>
                        </td>
                    </tr>
                @empty
                    <tr><td colspan="5" class="px-4 py-8 text-center text-gray-400">Tidak ada saldo awal yang perlu diverifikasi.</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
