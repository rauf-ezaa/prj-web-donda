...
@section('content')
    <div class="relative z-1 bg-white p-6 sm:p-0 dark:bg-gray-900">
        <div class="relative flex h-screen w-full flex-col justify-center sm:p-0 lg:flex-row dark:bg-gray-900">
                                ...
                                <div class="space-y-5">
                                    ...
                                    <div>
                                        <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                                            NRK<span class="text-error-500">*</span>
                                        </label>
                                        <input type="text" id="email" name="email" placeholder="Masukan NRK "
            ...
            <!-- Photo Panel -->
            <div class="relative hidden h-full w-full overflow-hidden lg:block lg:w-1/2">

                <!-- Background photo -->
                <div class="absolute inset-0 bg-cover bg-center bg-no-repeat"
                     style="background-image: url('/images/shape/auth1.jpeg')"></div>

                <!-- Gradient overlay: bening di atas, gelap di bawah -->
                <div class="absolute inset-0 bg-gradient-to-t from-brand-950 via-brand-950/40 to-transparent"></div>

                <!-- Subtle brand tint biar nyatu sama warna dashboard -->
                <div class="absolute inset-0 bg-brand-950/20"></div>

                <!-- Content, ditaruh di bawah -->
                <div class="relative z-1 flex h-full flex-col justify-end p-12 xl:p-36">
                    <a href="/" class="mb-6 inline-flex w-fit items-center gap-2 rounded-full bg-white/10 px-4 py-2 backdrop-blur-sm">
                        <img src="./images/logo/preview.png" alt="Logo" class="h-16 w-auto" />
                    </a>
                    <h2 class="mb-3 max-w-md text-3xl font-semibold text-white">
                        SIMANTAP
                    </h2>
