...
@section('content')
    ...
    <x-common.page-breadcrumb pageTitle="Edit Data Inventaris Barang"
    parentTitle="Data Inventaris Barang"
    :parentRoute="route('kartu-inventaris-barang.index')" />
    
    <x-form.form-kib.edit-inventaris 
    :dataDetailKib="$dataDetailKib" 
    />
