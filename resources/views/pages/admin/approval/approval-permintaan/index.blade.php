...
<div class="max-w-3xl mx-auto">
    <div class="flex justify-between items-center mb-5">
        ...
        <form method="GET" action="{{ route('admin.permintaan.index') }}">
            <select
            ...
            >
                <option value="pending" {{ $status_permintaan === 'pending' ? 'selected' : '' }}>
    ...
    @forelse ($permintaan as $item)
        ...
        @if ($item->is_accessible)
            <a href="{{ route('admin.permintaan.show', $item->id) }}" class="{{ $rowClasses }}">
        @else
