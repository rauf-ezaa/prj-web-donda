...
@section('content')
    <x-common.page-breadcrumb pageTitle="Data Kategori Barang" />
    <div class="flex items-center gap-5">
        <x-ui.button size="sm" onclick="window.location='{{ route('category.create') }}'" variant="primary" :startIcon="$BoxIcon">Tambah Jenis kategori</x-ui.button>
    ...
    <br>
        ...
        <!-- Table -->
            <x-tables.tables-list.tables-kategori 
            :kategori="$kategori"/>
    </div>
