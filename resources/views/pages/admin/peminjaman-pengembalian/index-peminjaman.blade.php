...
@section('content')
@section('content')
    <x-common.page-breadcrumb pageTitle="Data Peminjaman" />
    <div class="flex items-center gap-5">
        <x-ui.button size="sm" variant="primary" :startIcon="$BoxIcon">Tambah Peminjaman</x-ui.button>
    ...
    <br>
        <!-- Table -->
            <x-tables.tables-list.tables-peminjaman
