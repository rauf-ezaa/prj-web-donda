...
<x-common.page-breadcrumb pageTitle="Edit Data Pegawai"
parentTitle="Data Pegawai"
:parentRoute="route('data-karyawan.index')" />
    ...
    @if($errors->any())
        <div class="space-y-5 sm:space-y-6">
            <x-ui.alert
            variant="error"
            title="Gagal Update Data Karyawan."
    ...
    @endif
            ...
            <x-form.form-data-karyawan.edit-data-karyawan :data="$data"  />
@endsection