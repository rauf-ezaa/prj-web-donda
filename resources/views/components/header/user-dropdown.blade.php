<div class="relative" x-data="{
    ...
    >
        <!-- User Info -->
        <div>
            <span class="block font-medium text-gray-700 text-theme-sm dark:text-gray-400">nama users</span>
            <span class="mt-0.5 block text-theme-xs text-gray-500 dark:text-gray-400">email / nrk </span>
        </div>
