...
public static function saldoAwal(){
    ...
    public static function getKaryawanItems(){
        ...
        return [
 [
                'icon' => 'laporan_pengajuan',
                'name' => 'Statistik',
               	'subItems' => [
                    ['name' => 'Statistik Pengajuan',
										'path' => '/statistik/pengajuan',
                    'icon' => 'dashboard',
                    ],
 ...
 [
    ...
    public static function getMenuGroups()
    {
        $groups = [
            ...
            [
                'title' => 'Peminjaman Barang & Pengembalian Barang',
    ...
    public static function getIconSvg($iconName)
    {
            ...
            'calendar' => '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"><path fill-rule="evenodd" clip-rule="evenodd" d="M8 2C8.41421 2 8.75 2.33579 8.75 2.75V3.75H15.25V2.75C15.25 2.33579 15.5858 2 16 2C16.4142 2 16.75 2.33579 16.75 2.75V3.75H18.5C19.7426 3.75 20.75 4.75736 20.75 6V9V19C20.75 20.2426 19.7426 21.25 18.5 21.25H5.5C4.25736 21.25 3.25 20.2426 3.25 19V9V6C3.25 4.75736 4.25736 3.75 5.5 3.75H7.25V2.75C7.25 2.33579 7.58579 2 8 2ZM8 5.25H5.5C5.08579 5.25 4.75 5.58579 4.75 6V8.25H19.25V6C19.25 5.58579 18.9142 5.25 18.5 5.25H16H8ZM19.25 9.75H4.75V19C4.75 19.4142 5.08579 19.75 5.5 19.75H18.5C18.9142 19.75 19.25 19.4142 19.25 19V9.75Z" fill="currentColor"></path></svg>',
						...
						'laporan_pengajuan' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M8 3.75H14L19.25 9V19C19.25 20.242 18.242 21.25 17 21.25H8C6.757 21.25 5.75 20.242 5.75 19V6C5.75 4.757 6.757 3.75 8 3.75Z" stroke="currentColor" stroke-width="1.8" stroke-linejoin="round"/><path d="M14 3.75V9H19.25" stroke="currentColor" stroke-width="1.8" stroke-linejoin="round"/><path d="M9 16V13" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"/><path d="M12 16V10" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"/><path d="M15 16V12" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"/></svg>',

						'laporan' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M8 3.75H14L19.25 9V19C19.25 20.242 18.242 21.25 17 21.25H8C6.757 21.25 5.75 20.242 5.75 19V6C5.75 4.757 6.757 3.75 8 3.75Z" stroke="currentColor" stroke-width="1.8" stroke-linejoin="round"/><path d="M14 3.75V9H19.25" stroke="currentColor" stroke-width="1.8" stroke-linejoin="round"/><path d="M9 12H15" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"/><path d="M9 15.5H15" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"/><path d="M9 19H13" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"/></svg>',
